...
class _HomePageState extends State<HomePage> {
  ...
  void _incrementDzikir(String type) {
    setState(() {
      if (type == 'subhanallah') {
  ...
  Widget _buildDzikirHeaderCard({Key? key}) {
    return Container(
      key: key,
      width: double.infinity,
      height: 200,
            ...
            child: Row(
              ...
              children: [
                _buildDhikrCircle(
                  ...
                  _countSubhanallah,
                  33,
                  () => _incrementDzikir('subhanallah'),
                ),
                _buildDhikrCircle(
                  'Alhamdulillah',
                  _countAlhamdulillah,
                  33,
                  () => _incrementDzikir('alhamdulillah'),
                ),
                _buildDhikrCircle(
                  'Allahu Akbar',
                  _countAllahuAkbar,
                  33,
                  () => _incrementDzikir('allahu_akbar'),
                ),
                _buildDhikrCircle(
                  'Astaghfirullah',
                  _countAstaghfirullah,
                  33,
                  () => _incrementDzikir('astaghfirullah'),
                ),
              ],
            ),
          ),
                          ...
                          child: SizedBox(
                            ...
                            child: PageView(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 6),
                                  child: _buildDzikirHeaderCard(key: const ValueKey('dzikir_header')),
                                ),
                              ],
                            ),
                          ),
